...
function messageHandler(e) {
    ...
    switch(messageType){
        case("blur"):
            sendStatus("Worker started blur on data in rang:" + e.data.startX +"-"+(e.data.startX+e.data.width));
            ...
            sendStatus("Finish blur on data in rang >>"+e.data.startX+"-"+(e.data.width+e.data.startX) );
            break;
        default:
